      ...
      <Row gutter={12}>
        ...
        <Col span={span}>
          <Form.Item name='level' label={level.label || ''} className='mb-16'>
            <Select placeholder={level.placeholder || "选择经销商级别"} onSelect={value => handleSelect(value, 'level')}>
              {showAll && <Option value="">全部级别</Option>}
              <Option value="11">一级经销商</Option>
              <Option value="12">次级经销商</Option>
            </Select>
          </Form.Item>
        </Col>
        <Col span={span}>
          <Form.Item name='outlets' value={outletsVal} label={dealer.label || ''} className='mb-16'>
            {isAddPersonal ?
              <Select placeholder={dealer.placeholder || "选择所属经销商"} onSelect={value => handleSelect(value, 'outlets')}>
